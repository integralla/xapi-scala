...
object Statement extends StatementModelBase {
  override type T = Statement
  override implicit val decoder: Decoder[Statement] = deriveDecoder[Statement]
  override implicit val encoder: Encoder[Statement] = deriveEncoder[Statement].mapJson(_.dropNullValues)
}
