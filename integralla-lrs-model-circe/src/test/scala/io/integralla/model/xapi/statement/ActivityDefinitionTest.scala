...
class ActivityDefinitionTest extends UnitSpec {
  ...
  val nonInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), None, None, None, None, None, None, None, None, None, None)
  val nonInteractionActivityEncoded: String = """{"name":{"en-US":"Example Activity","it-IT":"Esempio di attività"},"description":{"en-US":"An xAPI activity","it-IT":"Un'attività xAPI"}}"""

  /* Non-Interaction Activity w/ Extensions */
  val activityWithExtensions: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), None, None, None, None, None, None, None, None, None, Some(extensions))
  val activityWithExtensionsEncoded: String = """{"name":{"en-US":"Example Activity","it-IT":"Esempio di attività"},"description":{"en-US":"An xAPI activity","it-IT":"Un'attività xAPI"},"extensions":{"http://example.com/extenions/boolean":true,"http://example.com/extenions/double":1.0,"http://example.com/extenions/string":"string","http://example.com/extenions/other":"{\"one\": 1, \"two\": 2}"}}"""
  ...
  val choiceInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.CHOICE), Some(choiceCorrectResponsePattern), Some(choiceInteractionComponents), None, None, None, None, None)
  ...
  val fillInInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.FILL_IN), Some(fillInCorrectResponsesPattern), None, None, None, None, None, None)
  ...
  val likertInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.LIKERT), Some(likertCorrectResponsePattern), None, Some(likertInteractionComponents), None, None, None, None)
  ...
  val longFillInCorrectResponsesPattern: List[String] = List("{case_matters=false}{lang=en}The purpose of the xAPI is to store and provide access to learning experiences.")
  val longFillInInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.LONG_FILL_IN), Some(longFillInCorrectResponsesPattern), None, None, None, None, None, None)
  ...
  val matchingInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.MATCHING), Some(matchingCorrectResponsePattern), None, None, Some(matchingInteractionComponentsSource), None, Some(matchingInteractionComponentsTarget), None)
  ...
  val numericInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.NUMERIC), Some(numericCorrectResponsesPattern), None, None, None, None, None, None)
  ...
  val otherInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.OTHER), Some(otherCorrectResponsesPattern), None, None, None, None, None, None)
  ...
  val performanceInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.PERFORMANCE), Some(performanceCorrectResponsePattern), None, None, None, Some(performanceInteractionComponents), None, None)
  ...
  val sequencingInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.SEQUENCING), Some(sequencingCorrectResponsePattern), Some(sequencingInteractionComponents), None, None, None, None, None)
  ...
  val trueFalseInteractionActivity: ActivityDefinition = ActivityDefinition(Some(nameLanguageMap), Some(descriptionLanguageMap), Some(interactionActivityType), Some(moreInfo), Some(InteractionType.TRUE_FALSE), Some(trueFalseCorrectResponsesPattern), None, None, None, None, None, None)
  ...
  describe("ActivityDefinition") {
    describe("[initialization / validation]") {
      ...
      it("should throw a statement validation exception when the activity type is cmi.interaction and an interaction type is not defined") {
    ...
    describe("[decoding]") {
      it("should successfully decode an activity definition") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](nonInteractionActivityEncoded)
      ...
      it("should successfully decode an activity definition with extensions") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](activityWithExtensionsEncoded)
      ...
      it("should successfully decode a interaction activity definition (choice)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](choiceInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (fill-in)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](fillInInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (likert)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](likertInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (long-fill-in)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](longFillInInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (matching)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](matchingInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (numeric)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](numericInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (other)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](otherInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (performance)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](performanceInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (sequencing)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](sequencingInteractionActivityEncoded)
      ...
      it("should successfully decode a interaction activity definition (true-false)") {
        val decoded: Either[io.circe.Error, ActivityDefinition] = decode[ActivityDefinition](trueFalseInteractionActivityEncoded)
