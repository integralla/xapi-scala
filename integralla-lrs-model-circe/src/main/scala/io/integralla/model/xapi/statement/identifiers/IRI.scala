...
case class IRI(value: String) extends StatementValidation with Equivalence {
  ...
  /** Generates a signature that can be used to test logical equivalence between objects
    ...
    * Comparison) and 5.3.2 (Syntax-Based Normalization) of RFC 3987, and SHOULD*
    * NOT handle them using any approaches described in 5.3.3 (Scheme-Based
    * Normalization) or 5.3.4 (Protocol-Based Normalization) of the same RFC, or any
    * other approaches.
    *
    * Here, we lower case both the schema and host name (if present) and sort the
    * query string parameters.
    *
    * By default, `scala-uri` will URL percent encode paths and query string parameters
    * upon parsing. We do nothing to override this behavior.
    *
